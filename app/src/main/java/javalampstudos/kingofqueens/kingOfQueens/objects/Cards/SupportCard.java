...

{
        ...
        public SupportCard(int x, int y, int width, int height, Bitmap Sprite, boolean player, int id, ManaTypes cardSchool, boolean destroyed, int pointerID , BuffType buff)
        {
